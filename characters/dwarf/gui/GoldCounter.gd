...
func _on_Dwarf_nuggets_got(amount : float) -> void:
	...
	increment.interpolate_property(self, "displayed_counter", displayed_counter, counter, amount * 0.05, Tween.TRANS_CUBIC, Tween.EASE_IN)
	increment.start()
...
func _on_Increment_tween_completed(object: Object, key: NodePath) -> void:
	pass